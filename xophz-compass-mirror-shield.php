 ...
 * Update URI:        https://github.com/HalloftheGods/xophz-compass-mirror-shield
 */
 ...
 */
define( 'XOPHZ_COMPASS_MIRROR_SHIELD_VERSION', '26.8.30' );
...
function deactivate_xophz_compass_mirror_shield() {
	Xophz_Compass_Mirror_Shield::deactivate();
}
...
add_action( 'plugins_loaded', 'run_xophz_compass_mirror_shield' );
